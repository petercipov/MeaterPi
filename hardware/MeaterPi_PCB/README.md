...
The test uses BCM GPIO17 at 10 kHz and sweeps the requested fan speed from 100% down to 20% and back up in a loop. Because Q1 inverts the signal, the script handles the inversion internally.
