...
The script uses BCM GPIO17 at 25 kHz and repeatedly sweeps the fan request between 95% and 10%, then requests 0% for 5 seconds. Each normal sweep step also holds for 5 seconds. Stop it with `Ctrl-C`; cleanup releases Q1 so the fan returns to full speed.
