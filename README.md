...
The script uses BCM GPIO17 at 10 kHz and repeatedly sweeps the fan request between 95% and 20%, holding each step for 5 seconds. Stop it with `Ctrl-C`; cleanup releases Q1 so the fan returns to full speed.
